...
final class ResourceCollection extends Resource
{
    ...
    /**
     * Оставляет только указанные поля у каждого элемента коллекции.
     *
    ...
    /**
     * Исключает указанные поля у каждого элемента коллекции.
     *
     * @param string|int|array<string|int> ...$fields
     */
    ...
    public function toArray(): array
    {
        ...
        foreach ($this->resource as $item) {
            ...
            $mapped = ResourceFieldFilter::apply($mapped, $this->onlyFields, $this->exceptFields);
